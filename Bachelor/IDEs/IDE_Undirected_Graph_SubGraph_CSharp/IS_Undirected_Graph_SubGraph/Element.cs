namespace IS_Undirected_Graph_SubGraph
{
    ...
    public class Element
    {
        ...
        public Element(DrawingElementEnum elementType, Point startPoint, Point endPoint, Font textFont, Color penColor, float penWidth, DashStyle penStyle, Color brushColor, HatchStyle hatchStyle, Color brushForeColor, String text)
        {
