namespace IS_Undirected_Graph
{
    ...
    class DrawingUtils
    {
        ...
        {
            List<Element> nodes = VectorUtils.findElementByType(DrawingElementEnum.NODE);
            if (nodes != null)
            {
                ...
                if (firstNode != null)
                {
                    ...
                    if (secondNode != null && secondNode != firstNode)
                    {
                        ...
                        this.Graphics.DrawLine(this.Pen, new Point((int)xf, (int)yf), new Point((int)xs, (int)ys));
                    }
                }
            }
        }

        private void DrawLineFromCenter(Point start, Point end)
        {
            List<Element> nodes = VectorUtils.findElementByType(DrawingElementEnum.NODE);
            if (nodes != null)
            {
                ...
                if (firstNode != null)
                {
                    ...
                    if (secondNode != null && secondNode != firstNode)
                    {
                        ...
                        this.Graphics.DrawLine(this.Pen, centerF, centerS);
                    }
                }
            }
        }
