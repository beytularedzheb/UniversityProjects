...
procedure TrsProfilerPoint.AsString;
begin
  min := FProfiler.TicksToStr(MinTicks);
  max := FProfiler.TicksToStr(MaxTicks);
  avg := FProfiler.TicksToStr(AvgTicks);
  last := FProfiler.TicksToStr(LastTicks);
end;
