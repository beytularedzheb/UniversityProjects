...
uses
  ...
  Data.Win.ADODB, Controls, Buttons, Classes, StdCtrls;
...
begin
  ...
  isPressedOK := InputQuery('Идентификация на служител', 'ID на служител:', workerIDLog);
  ...
  if isPressedOK then begin
    if checkWorker(workerIDLog) then begin
      ...
      MessageDlg('Грешен код!', mtCustom, [mbOK], 0)
    end;
  end;
end;
